...
#define PIO0_7_DIGIMODE_DIGITAL 0x01u /*!<@brief Select Digital mode.: Enable Digital mode. Digital input is enabled. */
#define PIO0_7_FUNC_ALT0 0x00u        /*!<@brief Selects pin function.: Alternative connection 0. */
